...
import {DatePicker, Dropdown, SearchInput, DataTable, exportData as exportDataUtil } from "../../../partials/account/ReportsReusableComponents"
...
const BlbReport = () => {
  ...
  // Handle export functionality
    const handleExport = (format, dataToExport) => {
      ...
      exportDataUtil(formattedData, format, "Blb-Bonus-report");
    };
